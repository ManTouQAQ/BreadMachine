package me.mantou.breadmachine.core.util.kookvoice;
...
public class VoiceWebSocketListener extends WebSocketListener {
    private final CompletableFuture<String> future;
    private int stage = 1;
    private volatile boolean dead = false;
    private final Callable<Void> onDead;

    public VoiceWebSocketListener(CompletableFuture<String> future, Callable<Void> onDead) {
        this.future = future;
        this.onDead = onDead;
    }
    ...
    public void onMessage(@NotNull WebSocket webSocket, @NotNull String text) {
        ...
        if (stage++ == 3) {
            ...
            JsonObject object = JsonParser.parseString(VoiceConstants.STAGE_4).getAsJsonObject();
